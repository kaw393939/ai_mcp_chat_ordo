...
## Alexander Osterwalder and the Business Model Canvas (2010)

**Alexander Osterwalder** published *Business Model Generation*, introducing the **Business Model Canvas** — a one-page framework that maps nine blocks:
