...
## Marty Cagan and the Product Discovery Gap (2008)
...
A feature that passes all four tests is worth building. A feature that fails any one is a bad bet.

**What frustrated him:** Product managers who acted as "feature brokers" between stakeholders and engineers instead of discovering what would actually move the business.
...
- **Impact**: How much will it move the target metric? (1 = minimal, 3 = massive)
- **Confidence**: How confident are we in the estimates? (100% = high, 50% = speculative)
- **Effort**: How many person-months will it take?

Score = (Reach × Impact × Confidence) / Effort

RICE forces explicit tradeoffs: a high-impact feature that affects few users scores lower than a moderate-impact feature that affects everyone. A speculative bet is discounted by its uncertainty.
...
This approach separates the *what* (outcome) from the *how* (bet). If the bet doesn't work, the team pivots to a different approach — the outcome doesn't change.
...
- Can you articulate what you are *not* building this quarter — and why?
- Are stakeholder requests treated as *inputs* to prioritization, not *outputs* of it?
