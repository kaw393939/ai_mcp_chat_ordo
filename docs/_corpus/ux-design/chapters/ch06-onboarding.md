...
## Samuel Hulick and the Bowling Lane (2014)

**Samuel Hulick** (UserOnboarding.com) analyzed hundreds of onboarding flows and identified a pattern: the best onboarding doesn't tour features — it gets the user to their **first meaningful outcome** as quickly as possible.

Hulick's bowling lane metaphor: users are rolling a ball toward pins (their goal). The product's job is to be the *bumper guards* that keep the ball in the lane — not to explain what bowling is. Feature tours explain bowling. Contextual guidance keeps the ball moving.
...
- Have you eliminated every non-essential step between sign-up and first value?
- Does your onboarding guide users toward their goal, or tour your features?
