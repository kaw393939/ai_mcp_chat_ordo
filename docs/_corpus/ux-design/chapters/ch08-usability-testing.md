...
## Teresa Torres and Continuous Discovery (2021)

**Teresa Torres** published *Continuous Discovery Habits* in 2021, arguing that product teams should interact with users *every week*, not just during scheduled research phases.

Her core framework: **opportunity solution trees** — visual maps that connect a desired outcome to the opportunities (user pain points) that could drive that outcome, and the solutions (design changes) that address those opportunities.
...
| **A/B testing** | Comparing two specific alternatives | No qualitative insight, massive scale |

The tradeoff is always between *depth* (how much you understand about why) and *scale* (how many data points you collect).
...
- Are testing insights connected to specific design decisions?
- Can you trace every major feature to a user insight?
