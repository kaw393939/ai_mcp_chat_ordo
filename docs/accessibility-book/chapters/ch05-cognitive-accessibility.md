...
- **Clear language**: avoid jargon, use short sentences, provide definitions
- **Predictable behavior**: same input always produces same output
- **Error recovery**: undo, back, cancel available at every step
- **Time tolerance**: no time-limited interactions without extension options
...
- Are time-limited interactions avoidable or extendable?
